# Guia de Upgrade — 5.0 (modernização PHP 8.2+ / Laravel 12–13)
...
| Laravel | 6–12 | **12 ou 13** (10 e 11 estão EOL com security advisories não corrigidos — o Composer atual bloqueia a instalação por padrão) |
...
- CI: matriz PHP 8.2–8.5 × Laravel 12–13 (`.github/workflows/build.yml`).
